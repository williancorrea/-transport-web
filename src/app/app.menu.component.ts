...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
       this.translate.get('app').subscribe(m => {
           ...
           this.model = [
               {label: m['menu']['dashboard'], icon: 'fa fa-fw fa-home', routerLink: ['/']},
               {
               ...
               {label:  m['permissoes-de-acesso']['menu'], icon: 'fa fa-fw fa-map-signs', routerLink: [m['permissoes-de-acesso']['link-pagina']], visible: this.auth.hasPermission('ROLE_ALTERAR_PERMISSOES_ACESSO')},
               {
               ...
               //         {label: 'Panels', icon: 'fa fa-fw fa-estadoCivilList-alt', routerLink: ['/panels']},
               ...
               // {label: 'Landing Page', icon: 'fa fa-fw fa-certificate', url: 'assets/pages/landing.html', target: '_blank'},
               {
                   ...
                   items: [
                       ...
                       {label: 'Error Page', icon: 'fa fa-fw fa-exclamation-circle', routerLink: ['/erro'], target: '_blank'},
                       {label: '404 Page', icon: 'fa fa-fw fa-times', routerLink: ['/page-not-found']},
                       {label: 'Denied Page', icon: 'fa fa-fw fa-exclamation-triangle', routerLink: ['/access-denied'], target: '_blank'}
                   ]
               }
               // {
